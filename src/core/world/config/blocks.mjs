 ...
 *
 * @typedef {Object} BlocksExtensions
 *
 ...
 *
 * @typedef {BlockDefinition[] & BlocksExtensions} Blocks
 */

/**
 * @typedef {Object} BlockMetadata
 *
 * @property {string} [text] - Text content (for Text blocks)
 * @property {Object} [params] - Parameters for block (for Link blocks)
 * @property {string} [worldName] - Name of linked world (for Link blocks)
 */
...
/**
 * Block name constants mapped to their display names.
 *
 * This object provides a mapping from uppercase, underscore-separated constant names
 * to human-readable block display names. Used throughout the application for block
 * identification and display purposes.
 *
 * @typedef {Record<string, string>} BlockNames
 */
...
const blockDefinitionsArray = [
  ...
  },
  {
    ...
    id: 81,
    breakTime: 0.5,
    drops: [blockNames.AGAVE, blockNames.AGAVE_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 43,
    breakTime: 0.5,
    drops: [blockNames.BAMBOO, blockNames.BAMBOO_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 42,
    breakTime: 0.5,
    drops: [blockNames.BERRY_BUSH, blockNames.BERRY_BUSH_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 115,
    breakTime: 0.5,
    drops: [blockNames.BIRCH, blockNames.BIRCH_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 23,
    breakTime: 0.5,
    drops: [blockNames.CACTUS, blockNames.CACTUS_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 21,
    breakTime: 0.5,
    drops: [blockNames.CARROT, blockNames.CARROT_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 45,
    breakTime: 0.5,
    drops: [blockNames.CORN, blockNames.CORN_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 48,
    breakTime: 0.5,
    drops: [blockNames.FERN, blockNames.FERN_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 92,
    breakTime: 0.5,
    drops: [blockNames.KELP, blockNames.KELP_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 87,
    breakTime: 0.5,
    drops: [blockNames.LAVENDER, blockNames.LAVENDER_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 109,
    breakTime: 0.5,
    drops: [blockNames.LOTUS, blockNames.LOTUS_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 22,
    breakTime: 0.5,
    drops: [blockNames.MUSHROOM, blockNames.MUSHROOM_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 46,
    breakTime: 0.5,
    drops: [blockNames.PINE_TREE, blockNames.PINE_TREE_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 103,
    breakTime: 0.5,
    drops: [blockNames.PUMPKIN, blockNames.PUMPKIN_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 96,
    breakTime: 0.5,
    drops: [blockNames.ROSE, blockNames.ROSE_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 44,
    breakTime: 0.5,
    drops: [blockNames.SUNFLOWER, blockNames.SUNFLOWER_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 10,
    breakTime: 0.5,
    drops: [blockNames.TREE_TRUNK, blockNames.WOOD],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 75,
    breakTime: 0.5,
    drops: [blockNames.TULIP, blockNames.TULIP_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 20,
    breakTime: 0.5,
    drops: [blockNames.WHEAT, blockNames.WHEAT_GROWING],
    solid: true,
    crop: true,
  },
  {
  ...
  },
  {
    ...
    id: 47,
    breakTime: 0.5,
    drops: [blockNames.WILLOW_TREE, blockNames.WILLOW_TREE_GROWING],
    solid: true,
    crop: true,
  },
  {
 ...
 */
export function getGravityBlocks() {
 ...
 * @returns {Set<BlockDefinition>}
 */
export function getNonGravityBlocks() {
 ...
 * @param {boolean} [includeSystemBlocks=true] - Whether to include Link and Text system blocks in cycling
 *
 * @returns {number}
 */
export function getNewBlockId(
  currentBlockId,
  blocks,
  isForward,
  includeSystemBlocks = true,
) {
  ...
  // If system blocks are not included, we need to find the next valid block
  if (!includeSystemBlocks) {
    ...
    // Keep cycling until we find a block that is NOT Link or Text
    const maxAttempts = blockCount;

    let attempts = 0;
    while (attempts < maxAttempts) {
      const block = blockDefinitionsArray[newIndex];
      const blockName = block.name.toUpperCase();
      if (blockName !== "LINK" && blockName !== "TEXT") {
        return Number(block.id);
      }

      // Continue cycling
      newIndex = isForward
        ? newIndex === blockCount - 1
          ? 1
          : newIndex + 1
        : newIndex === 1
          ? blockCount - 1
    ...
    // Fallback: return current block if somehow we can't find a valid one
    return currentBlockId;
  }

  // Default behavior: include all blocks
  const newIndex = isForward
    ...
    : currentIndex === 1
      ? blockCount - 1
      : currentIndex - 1;
  return Number(blockDefinitionsArray[newIndex].id);
}

/**
 * @param {BlockDefinition[]} blockDefinitionsArray
 *
 * @returns {Blocks}
 */
export function getBlocks(blockDefinitionsArray) {
  return Object.assign(blockDefinitionsArray, {
 ...
 * @type {Blocks}
 */
export const blocks = getBlocks(blockDefinitionsArray);
