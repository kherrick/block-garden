...
/**
 * @typedef {import('../chunkManager.mjs').BlockMetadata} BlockMetadata
 * @typedef {import('../lighting/lightSystem.mjs').LightMap} LightMap
 */
...
export class Chunk {
  ...
  constructor(chunkX, chunkZ) {
    ...
    /** @type {boolean} Whether terrain is currently being generated */
    ...
    /** @type {Map<number, BlockMetadata>} Index -> metadata object */
   ...
   * @param {Map<number, Object>|null} [metadata=null] - Index -> metadata map
   */
