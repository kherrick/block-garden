...
const GROWING = getBlockIdByName(blockNames.MUSHROOM_GROWING);
const STEM = getBlockIdByName(blockNames.MUSHROOM_STEM);
const CAP = getBlockIdByName(blockNames.MUSHROOM_CAP);
 ...
 */
export function generateMushroomStructure(x, y, z, progress) {
  const structure = [];
